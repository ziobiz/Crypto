...
Write-Host "=============================================="
Write-Host ""
Write-Host " [1] FTP upload"
Write-Host "     local: deploy\release\crypto-release.zip"
Write-Host "     A) /var/www/crypto-workflow/incoming/crypto-release.zip"
Write-Host "     B) /var/www/crypto-workflow/deploy/cafe24-business/crypto-release.zip"
Write-Host ""
Write-Host " [2] SSH deploy"
