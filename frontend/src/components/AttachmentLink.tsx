...
const PURPOSE_KEYS: Record<string, MessageKey> = {
  ...
  FUNDING_FORECAST_REPORT: 'attachment.FUNDING_FORECAST_REPORT',
  SOURCE_OF_FUNDS_DOC: 'attachment.SOURCE_OF_FUNDS_DOC',
  JP_TAX_SUPPORT_DOC: 'attachment.JP_TAX_SUPPORT_DOC',
